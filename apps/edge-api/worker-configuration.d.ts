/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 3ff19f96d0f4d339e9d0777cb21c1dc4)
// Runtime types generated with workerd@1.20260714.1 2026-07-19 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	ACCESS_CODE_HMAC: string;
	APP_ORIGIN: string;
	LOGIN_PEPPER: string;
	SESSION_SIGNING_SECRET: string;
	SNOWFLAKE_ACCOUNT_LOCATOR: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_CODE_HMAC" | "APP_ORIGIN" | "LOGIN_PEPPER" | "SESSION_SIGNING_SECRET" | "SNOWFLAKE_ACCOUNT_LOCATOR" | "SNOWFLAKE_HOST" | "SNOWFLAKE_PRIVATE_KEY" | "SNOWFLAKE_PUBLIC_KEY_FINGERPRINT" | "SNOWFLAKE_USER">> {}
}
