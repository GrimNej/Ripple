...
The official introductory session requirements are traced in [`OFFICIAL_SESSION_REQUIREMENTS.md`](OFFICIAL_SESSION_REQUIREMENTS.md). The participant dashboard remains the authority for the final field names and artifact format.

## Eligibility and artifacts

- [x] Working product and complete accessible source repository.
...
- [x] Browser/Worker retries cannot duplicate the Snowflake mutation.
